...
3. Run the `setup.py` script to setup your API key and the required parameters. This will create the `params.json` file, which is by default ignored by git in order to keep API keys anonymous *You only have to run this script once.*
